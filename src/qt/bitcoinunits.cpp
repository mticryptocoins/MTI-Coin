...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MTI");
    case mBTC: return QString("mMTI");
    case uBTC: return QString::fromUtf8("μMTI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MTIs");
    case mBTC: return QString("Milli-MTIs (1 / 1,000)");
    case uBTC: return QString("Micro-MTIs (1 / 1,000,000)");
    default: return QString("???");
    }
}
