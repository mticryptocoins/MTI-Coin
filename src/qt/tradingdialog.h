...
private slots:
    ...
    QString BuyMTI(QString OrderType, double Quantity, double Rate);
    QString SellMTI(QString OrderType, double Quantity, double Rate);
